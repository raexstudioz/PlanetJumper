...
func _ready():
	music_volume = GlobalVariables.MusicVolume if GlobalVariables.MusicVolume > 0 else 1.0
	sfx_volume = GlobalVariables.SFXVolume if GlobalVariables.SFXVolume > 0 else 1.0
